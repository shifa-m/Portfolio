...
const Page4 = () => {
  ...
  return (
    <div className='w-full bg-black text-white flex font-bold justify-center items-center  '>
      <div className='flex  rounded-4xl bg-black shadow-[0_0_30px_#6D326D] m-20'>
        ...
        <div className="w-1/2  h-100 text-xl m-40 text-white">
          ...
          <button onClick={handleMessage} className='mt-25 w-[40%] bg-[#6D326D] h-15 rounded-4xl flex justify-center items-center'>Send Message <ChevronRight className='ml-2 mt-2 ' size={30} /></button>
        </div>
      </div>
    </div>
